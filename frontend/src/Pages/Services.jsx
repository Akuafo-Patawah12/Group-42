...
const Services = () => {
  ...
  <div className="absolute z-30 w-full h-full bg-black/50 flex items-center justify-center">
    <a href="/" className="text-white font-bold text-xl">Home /</a><span style={{marginLeft:"5px"}} className="text-yellow-300 font-bold text-xl">Services</span>
  </div>
</section>
...
<div style={{marginBlock:"80px",marginInline:"auto"}} className="flex flex-col lg:flex-row justify-between items-center gap-8 mt-20 px-4 md:px-10 max-w-7xl mx-auto">
  ...
  <div className="w-full lg:w-1/2">
    ...
    <h3 style={{marginBlock:"10px"}} className="text-lg font-semibold text-gray-800 mb-2">Third Party Marketplace</h3>
    <p style={{marginBottom:"8px"}} className="text-md text-gray-600">
