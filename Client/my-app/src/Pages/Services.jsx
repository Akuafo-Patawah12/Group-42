...
<p className='text-sm'>SF Ghana Logistics provides reliable and cost-effective Sea Freight Services for clients with 
...
freight solutions are ideal for transporting bulk goods over long distances. <Link to={"/Services/SeaFreight"} style={seemore}>See more...</Link></p>
          ...
          <h3 style={h3}>Door-to-Door Delivery</h3>
            <p className='text-sm'>Our Door-to-Door Delivery Service offers a hassle-free solution, managing the entire logistics 
          ...
          <h3 style={h3}>Free Procurement and Sourcing Training</h3>
            <p className='text-sm'>Our Free Procurement and Sourcing Training empowers businesses with essential skills for 
          ...
          <h3  style={h3}>Container Clearance</h3>
            <p className='text-sm'>SF Ghana Logistics provides seamless Container Clearance Services, managing all customsrelated documentation and ensuring regulatory compliance. To support businesses with their 
          ...
          <p className='text-sm'>Our Groupage Services allow businesses with small to medium-sized shipments to save on costs 
     ...
     <div className="flex mt-[70px] w-[95%] mb-10 mx-auto justify-between">
     <div className="w-[45%]">
